...
class KeychainSuite extends FunSuite {
  ...
  test("parse keychain") {
    ...
    assert(keychain.head.entries(0).password === "wifi-password")
    ...
    assert(keychain.tail.head.entries(0).password === "app-password")
    ...
    assert(keychain.tail.head.entries(1).password === "hello world")
    ...
    assert(keychain.tail.head.entries(2).password === "password2")
    ...
    assert(keychain.tail.head.entries(3).password === "password1")
  }
}
